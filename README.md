...
```bash
VITE_PROXY = [["/jeecgboot","http://www.salary.gdhzairport.com:8080/jeecg-boot"],["/upload","http://www.salary.gdhzairport.com:3300/upload"]]
VITE_GLOB_DOMAIN_URL=http://www.salary.gdhzairport.com:8080/jeecg-boot
```
